 ...
 *  @OA\Property(property="adults_amount", type="number", format="int32", minimum=1, maximum=99, example="2"),
 *  @OA\Property(property="children_amount", type="number", format="int32", minimum=1, maximum=99, example="0"),
 *  @OA\Property(property="infants_amount", type="number", format="int32", minimum=1, maximum=99, example="0"),
 ...
 *  @OA\Property(property="notes", type="string", minLength=0, maxLength=65535, example="Lorem Ipsum is simply dummy text of the printing and typesetting industry."),
